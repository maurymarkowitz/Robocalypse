...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Robocalypse_ios",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15Robocalypse_ios11AppDelegate")
...
SWIFT_CLASS("_TtC15Robocalypse_ios12ArrowsSprite")
@interface ArrowsSprite : SKSpriteNode
- (nonnull instancetype)initWithTexture:(SKTexture * _Null_unspecified)texture color:(UIColor * _Nullable)color size:(CGSize)size OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC15Robocalypse_ios12ButtonSprite")
...
SWIFT_CLASS("_TtC15Robocalypse_ios12ObjectSprite")
...
SWIFT_CLASS("_TtC15Robocalypse_ios11FenceSprite")
@interface FenceSprite : ObjectSprite
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC15Robocalypse_ios13GameOverScene")
...
/// it.
SWIFT_CLASS("_TtC15Robocalypse_ios9GameScene")
...
SWIFT_CLASS("_TtC15Robocalypse_ios18GameViewController")
...
- (void)handleApplicationWillResignActive:(NSNotification * _Nonnull)note;
- (void)handleApplicationDidBecomeActive:(NSNotification * _Nonnull)note;
...
SWIFT_CLASS("_TtC15Robocalypse_ios10GridSprite") SWIFT_AVAILABILITY(ios,introduced=9)
...
SWIFT_CLASS("_TtC15Robocalypse_ios10PileSprite")
@interface PileSprite : ObjectSprite
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC15Robocalypse_ios12PlayerSprite")
@interface PlayerSprite : ObjectSprite
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC15Robocalypse_ios11RobotSprite")
@interface RobotSprite : ObjectSprite
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC15Robocalypse_ios10TankSprite")
@interface TankSprite : ObjectSprite
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithTexture:(SKTexture * _Nullable)texture color:(UIColor * _Nonnull)color size:(CGSize)size SWIFT_UNAVAILABLE;
@end
